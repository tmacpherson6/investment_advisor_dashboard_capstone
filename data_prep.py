    ...
    def __getitem__(self, idx):
        ...
        and volatility.
         - Therefore, each data sample (X_i) is a matrix consisting of a
           series (length of series = window_size) of past observation vectors,
           each (column) vector of dimension (X_dim).
         - Each label (y_i) is a (column) vector containing the computed
