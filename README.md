...
1. Ensure `data/annualized_volatility_predictions.csv` is present. This file is generated by running `notebooks/Pete-D1_Annualized-Volatility.ipynb`. A copy is committed to the repository.
...
All notebooks live in the `notebooks/` directory. They are organised by contributor and pipeline stage:
